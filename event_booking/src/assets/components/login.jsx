...
import { Link, useNavigate } from 'react-router-dom'; // 'data' hata diya, unused tha
            ...
            <div className="grid grid-cols-2 min-h-screen w-full bg-zinc-950 overflow-hidden">
                ...
                <div className="flex items-center justify-center h-screen">
                    <div className="relative w-[65%] h-[500px]">
                        <div className="absolute inset-0 translate-x-3 translate-y-3 border border-[#B65C7A] rounded-[35%_65%_45%_55%/25%_35%_65%_75%]"></div>
                        <img
                            src={sign_up}
                            alt="Evora"
                            className="w-full h-full object-cover rounded-[35%_65%_45%_55%/25%_35%_65%_75%]"
                        />
                        <div className="absolute inset-0 bg-black/35 rounded-[35%_65%_45%_55%/25%_35%_65%_75%]"></div>
                    </div>
                </div>
                ...
                <div className="w-[75%] bg-zinc-950 px-10 py-25">
                    ...
                    {/* LOGO */}
                    <div>
                        <img className="w-[130px] ml-38 mb-4 " src={myImg} alt="Evora" />
                    </div>
                    ...
                    <div>
                        ...
                        <form onSubmit={submit} className="mt-3 ml-10">
                            ...
                            {/* EMAIL */}
                            <label className="text-white tracking-wider text-sm font-serif" htmlFor="email">
                                Email Address
                            </label>
                            ...
                            {/* PASSWORD */}
                            <label className="text-white tracking-wider text-sm font-serif" htmlFor="password">
                                Password
                            </label>
